...
namespace COSML
{
    ...
    public static class ReflectionHelper
    {
        ...
        internal static void PreloadCommonTypes()
        {
            ...
            Parallel.Invoke
            (
                CacheFields<PlayerController>,
                CacheFields<PlaceController>,
                CacheFields<GameController>,
                CacheFields<UIController>
            );

            watch.Stop();

            Logging.API.Info($"Preloaded reflection in {watch.ElapsedMilliseconds}ms");
